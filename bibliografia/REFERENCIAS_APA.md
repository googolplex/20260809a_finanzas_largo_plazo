# Referencias APA del proyecto

Este archivo es la vista legible de `referencias.bib`. Se actualiza de manera acumulativa a medida que se incorporan nuevos materiales de referencia.

## Fuentes primarias recibidas para el proyecto
...
Universidad Americana. (s. f.). *Planificación didáctica semestral* [Plantilla institucional en Word y Excel].
...
Gatica-Lara, F., & Uribarren-Berrueta, T. del N. J. (2013). ¿Cómo elaborar una rúbrica? *Investigación en Educación Médica, 2*(5), 61–65. https://www.scielo.org.mx/scielo.php?script=sci_arttext&pid=S2007-50572013000100010

## Referencias mencionadas pero aún no identificadas de manera inequívoca
...
- El archivo `.bib` es la fuente de trabajo preferida para citación futura.
